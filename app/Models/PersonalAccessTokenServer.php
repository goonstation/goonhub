 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|\App\Models\PersonalAccessTokenServer indexFilter(\EloquentFilter\ModelFilter|string|null $filter = null, string $sortBy = 'id', bool $desc = true, int $limit = 15)
