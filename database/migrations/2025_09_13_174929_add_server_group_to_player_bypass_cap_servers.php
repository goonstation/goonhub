...
return new class extends Migration
{
    ...
    {
        Schema::table('player_bypass_cap_servers', function (Blueprint $table) {
            ...
            $table->dropUnique(['player_bypass_cap_id', 'server_id']);
            $table->unique(['player_bypass_cap_id', 'server_id', 'server_group_id']);
        });
    }
    ...
    public function down(): void
    {
        Schema::table('player_bypass_cap_servers', function (Blueprint $table) {
            ...
            $table->dropUnique(['player_bypass_cap_id', 'server_id', 'server_group_id']);
